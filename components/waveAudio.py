...
def waveSound(freq,data,numHarms,harmonicSeries,FS): ## Holds whole audio file and writes to memory when finished
    ...
    def waveform(list,targetHarm,harmMultiplier):     #Returns signal that gradually morphs final form
        ...
        while i<targetHarm:
            sine=makeSineSound(data,i*harmMultiplier+1,freq) # Make a wave for eiher odd values of i or all values of i
